  ...
  return (
    ...
    >
      <div className="code-block" style={{ padding: currentPadding }}>
        ...
        <div className="handle handle-left absolute left-[-4px] top-1/2 w-2 h-2 rounded-fullbg-slate-300 hover:bg-slate-50"></div>
        ...
        <div className="code-title h-[52px] px-4 flex items-center justify-between bg-black bg-opacity-80 rounded-tl-lg rounded-tr-lg border-2 border-[rgba(249,249,249,0.08)]">
          ...
          <div className="input-control w-full">
            <input
              ...
              className="w-full text-[hsla(0,0%,100%,0.6)] outline-none font-medium text-center bg-transparent py-2"
            />
          </div>
